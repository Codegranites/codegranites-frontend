...
import service from '../../../public/services-hero.png';
import serviceMobile from '../../../public/services-hero-mobile.png';
  ...
  return (
    <section className="relative h-[500px] sm:h-[720px] w-full">
      <div className="w-full h-full max-h-[720px] hidden sm:block absolute top-0 left-0">
        <Image src={service} alt="hero image" width={1440} height={435} priority className="w-full h-full object-cover" />
      </div>
      <div className="w-full h-full max-h-[650px] sm:hidden absolute top-0 left-0">
        <Image src={serviceMobile} alt="hero image" width={380} height={500} priority className="w-full h-full object-cover" />
      </div>
